...
enum Result
{
    ...
    ERROR_SCENE_UNSUPPORTED_SOURCE_GEOMETRY_INDEX_DATA = -6021,
};
...
inline const char* ToString(ppx::Result value)
{
    ...
    switch (value) {
        ...
        // TOOO: Add missing cases
        case Result::ERROR_SCENE_UNSUPPORTED_SOURCE_GEOMETRY_INDEX_DATA : return "ERROR_SCENE_UNSUPPORTED_SOURCE_GEOMETRY_INDEX_DATA";
    }
    // clang-format on
