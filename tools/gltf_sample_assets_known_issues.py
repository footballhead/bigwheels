...
KNOWN_ISSUES: dict[str, Optional[list[int]]] = {
    ...
    #'MultiUVTest-glTF-Embedded': [454],
    #'MultiUVTest-glTF': [],
    #'MultiUVTest-glTF-Binary': [],
    #'MultipleScenes-glTF-Embedded': [454],
    #'MultipleScenes-glTF': [],
    #'NegativeScaleTest-glTF': [],
    ...
    #'OrientationTest-glTF-Embedded': [454],
    #'OrientationTest-glTF': [],
    #'OrientationTest-glTF-Binary': [],
    'PotOfCoals-glTF': [462],
    'PotOfCoals-glTF-Binary': [262],
    #'PrimitiveModeNormalsTest-glTF': [],
    #'RecursiveSkeletons-glTF': [],
    #'RecursiveSkeletons-glTF-Binary': [],
    #'RiggedFigure-glTF-Embedded': [454],
    #'RiggedFigure-glTF': [],
    #'RiggedFigure-glTF-Binary': [],
    #'RiggedFigure-glTF-Draco': [455],
    #'RiggedSimple-glTF-Embedded': [454],
    #'RiggedSimple-glTF': [],
    #'RiggedSimple-glTF-Binary': [],
    #'RiggedSimple-glTF-Draco': [455],
    ...
    #'SimpleInstancing-glTF-Binary': [],
    #'SimpleMaterial-glTF-Embedded': [454],
    #'SimpleMaterial-glTF': [],
    #'SimpleMeshes-glTF-Embedded': [454],
    #'SimpleMeshes-glTF': [],
    #'SimpleMorph-glTF-Embedded': [454],
    #'SimpleMorph-glTF': [],
    #'SimpleSkin-glTF-Embedded': [454],
    #'SimpleSkin-glTF': [],
    #'SimpleSparseAccessor-glTF-Embedded': [454],
    #'SimpleSparseAccessor-glTF': [],
    #'SimpleTexture-glTF-Embedded': [454],
    #'SimpleTexture-glTF': [],
    #'SpecGlossVsMetalRough-glTF': [],
    #'SpecGlossVsMetalRough-glTF-Binary': [],
    #'SpecularSilkPouf-glTF': [],
    #'SpecularSilkPouf-glTF-Binary': [],
    #'SpecularTest-glTF': [],
    ...
    #'Suzanne-glTF': [],
    #'TextureCoordinateTest-glTF-Embedded': [454],
    ...
    #'TextureSettingsTest-glTF-Embedded': [454],
