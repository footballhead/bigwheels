...
def main():
  ...
  parser.add_argument('-j', '--jobs', type=int, default=None,
                      help='How many tests to run in parallel. Default is "as much as the CPU can reasonably handle"')
  ...
  # The difference between ThreadPoolExecutor and ProcesPoolExecutor seems like a wash on Linux
  with concurrent.futures.ThreadPoolExecutor(max_workers=args.jobs) as executor:
    futures_to_test_name = {executor.submit(_run_test, program, test_cases[test_name], args.output / test_name): test_name for test_name in test_cases}
